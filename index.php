...
?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="banner-sahyog mt-4 text-center">
                    <a href="donate-for-flood-victims-in-pujab-and-himachal.php">
    <img src="images/flood-relief.jpg" class="img-fluid w-100" alt="Banner Sahyog" style="margin:0 auto;">
    </a>
            ...
            <div class="col-md-6">
                <div class="banner-sahyog mt-4 text-center">
                    <a href="urgent-attention.php">
    <img src="images/emergency-case.jpg" class="img-fluid w-100" alt="Banner Sahyog" style="margin:0 auto">
    </a>
        ...
        <div class="container">
            ...
            <div class="row row-gap-3 mt-4">
                <div class="bulletin-board">
                    ...
                    <div class="clipping" style="width: 170.794px; height: 161.4px; left: 150.368px; top: 154.3342px; transform: rotate(-11deg);">
                        <div class="pin"></div><img src="https://sahyogcare4u.org/images/news11.jpg" alt="Clipping 1" style="width: 100%; height: 100%; object-fit: contain;">
                    </div>
                    <div class="clipping" style="width: 170.794px; height: 161.4px; left: 200.368px; top: 254.3342px; transform: rotate(-11deg);">
                        <div class="pin"></div><img src="https://sahyogcare4u.org/images/news22.jpg" alt="Clipping 1" style="width: 100%; height: 100%; object-fit: contain;">
                    </div>
                    <div class="clipping" style="width: 170.794px; height: 161.4px; left: 200.368px; top: 354.3342px; transform: rotate(-11deg);">
                        <div class="pin"></div><img src="https://sahyogcare4u.org/images/news33.jpg" alt="Clipping 1" style="width: 100%; height: 100%; object-fit: contain;">
                    </div>
    ...
    <script>
        const clippings = [
            'https://sahyogcare4u.org/images/news11.jpg',
                 'https://sahyogcare4u.org/images/news22.jpg',
                 'https://sahyogcare4u.org/images/news33.jpg',
