...
<head>
    ...
    <title>Sahyog Care For You - Our mission is to rescue, rehabilitate, and empower children with education and a safe environment.
...
<body>
    ...
    <div class="contact-banner-sec mt-4">
        <h1 class="text-center text-bold child-labour-heading">Appeal for Help - Help Punjab & Himachal</h1>
    </div>
...
-->
                            ...
                            $slugs = [
                                "/donate-for-flood-victims-in-pujab-and-himachal.php",
