...
include('lock.php');
$where = [];
$sql_count = "SELECT count(*) as total FROM `enquiry` WHERE 1=1 ";
...
$sql   = "SELECT * FROM `enquiry` WHERE 1=1 ORDER BY id DESC LIMIT :start,:limit";
                              ...
                              <tbody>
                                 ...
                                 ?>
                                    <tr>
                                       ...
                                       <td><?= $row['tstp'] ?></td>
                                       <td>
                                       <a href="delete-enquiry.php?id=<?=base64_encode($row['id'])?>" 
