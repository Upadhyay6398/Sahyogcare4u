...
include('lock.php');
$where = [];
$sql_count = "SELECT count(*) as total FROM `psu` WHERE 1=1 ";
...
$sql   = "SELECT * FROM `psu` WHERE 1=1 ORDER BY id DESC LIMIT :start,:limit";
               ...
               <div class="col-md-12">
                  <div class="panel">
                     <div class="panel-heading">
                        <h4 class="panel-title">Manage Psu Details</h4>
