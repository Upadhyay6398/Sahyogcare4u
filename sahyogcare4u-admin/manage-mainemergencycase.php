...
include('lock.php');
$where = [];
$sql_count = "SELECT count(*) as total FROM `mainemergencycase` WHERE 1=1 ";
...
$sql   = "SELECT * FROM `mainemergencycase` WHERE 1=1 ORDER BY id DESC LIMIT :start,:limit";
   ...
   <div id="page-content-wrapper">
      <div id="page-content">
         <div class="container">
            ...
            <!--======*********======= page title div==***********==-->
            <div id="page-title">
               <h2>Manage Main Emergency Case</h2>
            </div>
            <!--=========*************= End====**********===========-->
            <?php
                  ...
                  <div class="panel">
                     ...
                     <div class="panel-body">
                        <div class="example-box-wrapper">
                              ...
                              <tbody>
                                 ...
                                 ?>
                                    <tr>
                                       ...
                                       <td><?= $row['metakeyword'] ?></td>
                                       <td>
                                       <a href="edit-mainemergencycase.php?id=<?=base64_encode($row['id'])?>" 
                                       onclick="return confirm('Are you sure you want to update this data?');">
                                        Update
                                     </a>
                                       </td>
                                       <td>
                                       <a href="delete-mainemergencycase.php?id=<?=base64_encode($row['id'])?>" 
                           ...
                           <a href="add-mainemergencycase.php">
