<div id="page-header"  class="bg-red font-inverse">
    <div id="mobile-navigation">
        <button id="nav-toggle" class="collapsed" data-toggle="collapse" data-target="#page-sidebar"><span></span></button>
        <a href="index.html" class="logo-content-small" title="MonarchUI"></a>
    </div>
    
<!--========== the header logo code is here and logo url is in Css  =========--> 
    ...
    <div id="header-logo" class="logo-bg">
        ...
        <a id="close-sidebar" href="#" title="Close sidebar">
            <i class="header_arrow glyph-icon icon-angle-left"></i>
        </a>
    </div>
    
    
    <!--<div id="thumb-sidebar" class="logo-bg">
    <!--     &nbsp;-->
    <!--    <a id="close-sidebar" href="#" title="Close sidebar">-->
    <!--        <i class="header_thumb glyph-icon icon-angle-left"></i>-->
    <!--    </a>-->
    <!--</div>-->
    <!--<div id="thumb-sidebar2" class="logo-bg" style="display:none">
            <i class="header_thumb glyph-icon icon-angle-right"></i>
        </a>
    </div>-->
