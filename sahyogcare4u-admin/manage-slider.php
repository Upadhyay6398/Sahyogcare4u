...
include('lock.php');
$where = [];
$sql_count = "SELECT count(*) as total FROM `slider` WHERE 1=1 ";
...
$sql   = "SELECT * FROM `slider` WHERE 1=1 ORDER BY id DESC LIMIT :start,:limit";
               ...
               <div class="col-md-12">
                  <div class="panel">
                     <div class="panel-heading">
                        <h4 class="panel-title">Manage Slider</h4>
                              ...
                              <tbody>
                                 ...
                                 ?>
                                    <tr>
                                       ...
                                       <td>
                                       <a href="edit-slider.php?id=<?=base64_encode($row['id'])?>" 
                                       onclick="return confirm('Are you sure you want to update this data?');">
                                        Update
                                     </a>
                                       </td>
                                       <td>
                                       <a href="delete-slider.php?id=<?=base64_encode($row['id'])?>" 
