...
$subprogram1     = $DB->getRowById('albumb', $subprogram_id1);
$subprogram_id = cleanId($_GET['id']);
$subprogram = $DB->getRowById('subprogram_gallery', $subprogram_id);
...
if (isset($_POST['Submit'])) { 
    ...
    if (!empty($_POST['title']) && isset($_FILES['image'])) {
        foreach ($_POST['title'] as $key => $title) {
            ...
            if ($entryId > 0) {
                $DB->update('subprogram_gallery', $entryData, $entryId);
            } else {
                $DB->insert('subprogram_gallery', $entryData);
            }
...
<body>
    ...
    <div id="page-content-wrapper">
        <div id="page-content">
            <div id="page-title">
                <h2>Update Sub Program Gallery</h2>
            </div>
            <?php include("include/message.php"); ?>
            <div class="col-md-7">
                <div class="panel">
                    <div class="panel-heading">
                        <h4 class="panel-title">Update Sub Program Gallery</h4>
                    </div>
                        ...
                        <div class="example-box-wrapper">
                            <form class="form-horizontal bordered-row" enctype="multipart/form-data" id="change-laverage-form" method="post" data-parsley-validate="">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Albumb Name</label>
                                    <div class="col-sm-6">
                                        <input type="text" id="documents" class="form-control" name="subprogram_id" value="<?php echo $subprogram1['event_name']; ?>" required readonly />
                                    </div>
                                </div>
                                <div id="form-container">
                                    <?php foreach ($programtimelines as $entry): ?>
                                        <div class="form-entry">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Sub Program title</label>
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control" name="title[]" value="<?= htmlspecialchars($entry['title']) ?>" >
                                                </div>
                                            </div>
                                            <div class="form-group">
    <label class="col-sm-3 control-label">Sub Program Gallery Image</label>
    <div class="col-sm-6">
        ...
        <img id="img-<?= $entry['id'] ?>" src="<?= htmlspecialchars($imagePath) ?>" alt="Preview" style="max-width: 100px; margin-top: 10px;" />
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-offset-3 col-sm-6 text-end">
                                                   <a href="delete-image.php?id=<?= base64_encode($entry['id']) ?>"
   ...
   class="btn btn-sm btn-danger">Delete</a>
    ...
    <script>
        ...
        function addEntry() {
            ...
            div.innerHTML = `
                <div class="form-group">
                    <label class="col-sm-3 control-label">Gallery title</label>
                    <div class="col-sm-6">
