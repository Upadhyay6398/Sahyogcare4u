            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="footer-column">
                        <h4>Donate Now</h4>
                        <div class="footer-qr">
                            <img src="images/qr-union-bank.jpg" class="img-fluid mb-2" alt="QR Code">
                        </div>
                        <span>(For donation receipts / tax exemption receipts,  contact us on WhatsApp )</span>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="footer-column">
                        ...
                        <div class="footer-social">
                            ...
                            <a target="_blank" href="https://www.youtube.com/@SahyogCare4You"><i class="fa-brands fa-youtube"></i></a>
                        </div> 
                        <h4>Newsletter</h4>
